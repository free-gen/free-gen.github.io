...
## <a id="02"> ПОДКЛЮЧЕНИЕ И НАСТРОЙКА
...
## <a id="03"> ИНСТРУКЦИЯ ПО ЭКСПЛУАТАЦИИ
...
#### 6.5 Переключение режима управления
...
#### Датчик температуры
- Датчик находится внутри процессора, его выводы **SDA** и **SCL** должны быть подключены к соответствующим линиям на плате, которые через мультиплексор/преобразователь попадают на GPIO8 и GPIO9 ESP32.
...
## <a id="05"> ЧАСТО ЗАДАВАЕМЫЕ ВОПРОСЫ (FAQ)
