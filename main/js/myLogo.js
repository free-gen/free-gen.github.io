...
let materialEmissive = 0x2930ff; // свечение материала
let materialSpecular = 0xff7a7a; // цвет бликов
let materialRoughness = 0.2; // шероховатость материала
...
let rotationSpeed = 10; // скорость вращения
let jumpSpeed = 8; // скорость прыжка
let model; // инициализация
let modelRotate = { x: 100, y: 0, z: 5 }; // наклон модели
let modelPosition = { x: 0, y: 0.05, z: 3 } // позиционирование модели
